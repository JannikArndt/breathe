...
const STRINGS = {
  de: {
    ...
    'rev.cap':        'Mit zwei Fingern aufziehen',
    'rev.length':     'Dauer',
    'rev.selected':   'Ausgewählt',
    'rev.breaths':    'Atemzüge',
    'rev.median':     'Tempo im Mittel',
    'rev.avg':        'Tempo im Schnitt',
    'rev.p95':        'Tempo p95',
    'rev.held':       'Still gehalten',
    'rev.longhold':   'Längste Pause',
    'rev.dist':       'Atemtempo',
    'rev.nodist':     'Zu wenige Atemzüge in diesem Abschnitt',
    'rev.phase':      'Ein Atemzug, in vier Teilen',
    'rev.in':         'Ein',
    'rev.top':        'Oben',
    'rev.out':        'Aus',
    'rev.bottom':     'Unten',
    'rev.ratio':      'Verhältnis',
    'rev.hr':         'Herzschlag',
    ...
    'rev.noflag.rest':'Diese Aufnahme entstand, bevor die App gespeichert hat, wo sie eine Pause gehört hat. Deshalb bleiben die beiden Pausenwerte leer.',
    'rev.noflag.trunc':'Rohdaten wurden nur für die ersten {0} gespeichert, deshalb endet der Herzschlag dort. Die Atemkurve läuft bis zum Schluss.',
