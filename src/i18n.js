...
const STRINGS = {
  de: {
    ...
    'home.fine':      'Der Klang folgt deinem Bauch und läuft, bis du ihn beendest.',
    'home.fine2':     'Die Bewegungsdaten verlassen dieses Handy nicht. Sitzungen bleiben hier und gehen nirgendwohin, außer du exportierst sie. Ein Entspannungswerkzeug, kein Medizinprodukt.',
    'btn.start':      'Start',
    'btn.end':        'Ende',
    'tag.standby':    'bereit',
    ...
    'adj.nerd':       'Zahlen zeigen',
    'adj.nerd.hint':  'was der Sensor gerade liefert, unter der Kurve',
    ...
    'rev.cap':        'Die Linie ist dein Atemtempo. Die Schattierung dahinter zeigt, wie tief jeder Atemzug war.',
    'rev.length':     'Dauer',
    ...
    'rev.trim.from':  'Beginnt hier',
    'rev.trim.to':    'Endet hier',
    'rev.trim.clear': 'Alles verwenden',
    'rev.trim.all':   'Alles ist als brauchbar markiert.',
    'rev.trim.some':  'Brauchbar: {0} bis {1} von {2}',
